...
SERVICE_ACCOUNT_FILE = (
    "../service-account.json"  # 👈 Replace this with your actual path
)
SCOPES = [
...
TEXT_TO_INSERT = (
    "Hello world! This text was added via the Google Docs API using Python 🚀"
)
SHARE_WITH_EMAIL = (
    "eden@neuralberta.tech"  # 👈 Optional: Replace or remove if not needed
)
# --------------------------------------
...
docs_service.documents().batchUpdate(
    documentId=doc_id, body={"requests": insert_text_request}
).execute()
