...
class Skill(ConfiguredBaseModel):
    """
    A requisite skill to fulfill a role in a process
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://processieve.com/schemas/v0#'})
...
class Proficiency(ConfiguredBaseModel):
    ...
    level: float = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'level', 'domain_of': ['Proficiency']} })
    skill: str = Field(default=..., json_schema_extra = { "linkml_meta": {'alias': 'skill', 'domain_of': ['Proficiency']} })
...
class Template(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'abstract': True, 'from_schema': 'https://processieve.com/schemas/v0#'})
